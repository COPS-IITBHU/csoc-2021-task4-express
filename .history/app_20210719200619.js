...
controllers folder.
*/
mongoose.connect('mongodb+srv://rit:mongo123@cluster0.4nsv4.mongodb.net/library?retryWrites=true&w=majority',{ useNewUrlParser: true,useUnifiedTopology: true })
app.get("/addbooks",()=>{
  const book1=new Book({
    title:"book2",
    genre:"pop",
    author:"weekend",
    description:"1billion sales",
    rating:4.5,
    mrp:34,
    available_copies:5
