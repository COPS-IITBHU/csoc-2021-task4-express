...
var getBook = (req, res) => {
   ...
   obj.Book.findById(req.params.id,((err,res)=>{
       idBook=res;
       if(err)
       {
           console.log(err);
...
var issueBook = (req, res) => {
    var id=req.body.bid;
    var title = "";
    obj.Book.findById(id)
    .then((book) => {
        title=book.title;
        // BookCopy.findOne({status:true,book:title})
        // .then((result) => {
                BookCopy.updateOne({status:true,book:title},{
                    status:false,
...
var searchBooks = (req, res) => {
    ...
    {
        obj.Book.find({title:req.body.title, author:req.body.author, genre:req.body.genre},(err,resPar)=>{
            if(err){
                console.log(err);
            }else{
    ...
    {
        obj.Book.find({ author:req.body.author, genre:req.body.genre},(err,resPar)=>{
            if(err){
                console.log(err);
            }else{
                res.render("book_list",{books:resPar, title:"Searched List"})
    ...
    {
        obj.Book.find({title:req.body.title, genre:req.body.genre},(err,resPar)=>{
            if(err){
                console.log(err);
            }else{
                res.render("book_list",{books:resPar, title:"Searched List"})
    ...
    {
        obj.Book.find({title:req.body.title, author:req.body.author},(err,resPar)=>{
            if(err){
                console.log(err);
            }else{
                res.render("book_list",{books:resPar, title:"Searched List"})
    ...
    {
        obj.Book.find({ genre:req.body.genre},(err,resPar)=>{
            if(err){
                console.log(err);
            }else{
                res.render("book_list",{books:resPar, title:"Searched List"})
    ...
    {
        obj.Book.find({ author:req.body.author},(err,resPar)=>{
            if(err){
                console.log(err);
            }else{
                res.render("book_list",{books:resPar, title:"Searched List"})
    ...
    {
        obj.Book.find({title:req.body.title},(err,resPar)=>{
            if(err){
                console.log(err);
            }else{
                res.render("book_list",{books:resPar, title:"Searched List"})
