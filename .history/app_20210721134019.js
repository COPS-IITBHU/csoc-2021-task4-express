...
app.post("/delete",(req,res)=>{
  Book.findOne({title:req.body.title,genre:req.body.genre,author:req.body.author},function(err,foundBo){
    if(err){
      console.log(err);
    }else{
      BookCopy.findOne({borrow_data:req.body.borrow_data,borrower:req.user.username,book:book},function(err,foundBookCopy);
    }
  });
});
